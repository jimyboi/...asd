...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-8 text-right" style="margin-top:20px; margin-bottom:50px;">
              <?php if ($this->session->userdata('thenetworkplusadmin')): ?>
                <a href="<?php echo base_url('admin/logout'); ?>" style="color:black;font-size:16px;font-family:Calibri,sans-serif;letter-spacing:2px;cursor:pointer;text-decoration:none;">Logout</a><br>
              <?php endif ?>
            </div>
        ...
        <div class="col-md-6"></div>
            ...
            <?php if ($this->session->userdata('thenetworkplusadmin')): ?>
              <div class="col-md-6" style="margin-top: -50px;">
                <?php $this->load->view('admin/sidebar2'); ?>
            </div>
              <?php endif ?>
...
<hr style="border:1px solid #9a9b9c;"> 
